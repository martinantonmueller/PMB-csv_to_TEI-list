...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Dieses XSL auf schnitzler-briefe-refs angewendet, sollte alle Werk-Entitäten aus der PMB holen -->
    <xsl:template match="tei:listOrg | tei:listPerson | tei:listPlace"/>
